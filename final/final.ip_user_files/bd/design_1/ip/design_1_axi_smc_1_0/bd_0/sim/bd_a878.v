...
(* CORE_GENERATION_INFO = "bd_a878,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_a878,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=51,numReposBlks=39,numNonXlnxBlks=0,numHierBlks=12,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "design_1_axi_smc_1_0.hwdef" *) 
module bd_a878
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  s02_entry_pipeline_imp_1BSPY9B s02_entry_pipeline
       (.aclk(aclk_3),
        .aresetn(aresetn_4),
  ...
  s02_nodes_imp_1E864FL s02_nodes
  ...
  s03_entry_pipeline_imp_FBK4MZ s03_entry_pipeline
       (.aclk(aclk_4),
        .aresetn(aresetn_5),
  ...
  s03_nodes_imp_B3YKCN s03_nodes
...
module s02_entry_pipeline_imp_1BSPY9B
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_a878_s02mmu_0 s02_mmu
       (.aclk(aclk),
        ...
        .s_axi_rresp(s_axi_rresp),
        .s_axi_rvalid(s_axi_rvalid));
  bd_a878_s02sic_0 s02_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_araddr(m_axi_araddr),
        .m_axi_arcache(m_axi_arcache),
  ...
  bd_a878_s02tr_0 s02_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
...
module s03_entry_pipeline_imp_FBK4MZ
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_a878_s03mmu_0 s03_mmu
       (.aclk(aclk),
        ...
        .s_axi_rresp(s_axi_rresp),
        .s_axi_rvalid(s_axi_rvalid));
  bd_a878_s03sic_0 s03_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_araddr(m_axi_araddr),
        .m_axi_arcache(m_axi_arcache),
  ...
  bd_a878_s03tr_0 s03_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
