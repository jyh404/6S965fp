...
(* CORE_GENERATION_INFO = "bd_69f9,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_69f9,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=43,numReposBlks=33,numNonXlnxBlks=0,numHierBlks=10,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "design_1_axi_smc_1_2.hwdef" *) 
module bd_69f9
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  m00_nodes_imp_4U8DZA m00_nodes
  ...
  s01_entry_pipeline_imp_OQ61X9 s01_entry_pipeline
       (.aclk(aclk_2),
        .aresetn(aresetn_3),
  ...
  s01_nodes_imp_KRQ0ED s01_nodes
  ...
  s02_entry_pipeline_imp_DB9R0G s02_entry_pipeline
       (.aclk(aclk_3),
        .aresetn(aresetn_4),
  ...
  s02_nodes_imp_F6NXB2 s02_nodes
  ...
  switchboards_imp_1G790X3 switchboards
...
module s01_entry_pipeline_imp_OQ61X9
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awcache,
  ...
  bd_69f9_s01mmu_0 s01_mmu
       (.aclk(aclk),
        ...
        .s_axi_wstrb(s_axi_wstrb),
        .s_axi_wvalid(s_axi_wvalid));
  bd_69f9_s01sic_0 s01_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_awaddr(m_axi_awaddr),
        .m_axi_awcache(m_axi_awcache),
  ...
  bd_69f9_s01tr_0 s01_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
...
module s02_entry_pipeline_imp_DB9R0G
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_69f9_s02mmu_0 s02_mmu
       (.aclk(aclk),
        ...
        .s_axi_rresp(s_axi_rresp),
        .s_axi_rvalid(s_axi_rvalid));
  bd_69f9_s02sic_0 s02_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_araddr(m_axi_araddr),
        .m_axi_arcache(m_axi_arcache),
  ...
  bd_69f9_s02tr_0 s02_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
...
module switchboards_imp_1G790X3
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
