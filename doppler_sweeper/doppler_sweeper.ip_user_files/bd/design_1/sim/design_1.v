...
module design_1
  ...
  wire [7:0]fft_convolve_0_M_OUTPUT_DATA_TSTRB;
  wire fft_convolve_0_M_OUTPUT_DATA_TVALID;
  wire [2:0]ilconstant_0_dout;
  wire [5:0]ilconstant_1_dout;
  ...
  design_1_argmax_0_0 argmax_0
       (.m00_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s00_axis_tdata(fft_convolve_0_M_OUTPUT_DATA_TDATA),
        .s00_axis_tlast(fft_convolve_0_M_OUTPUT_DATA_TLAST),
        .s00_axis_tready(fft_convolve_0_M_OUTPUT_DATA_TREADY),
        .s00_axis_tstrb(fft_convolve_0_M_OUTPUT_DATA_TSTRB),
        .s00_axis_tvalid(fft_convolve_0_M_OUTPUT_DATA_TVALID));
  ...
  design_1_axi_smc_1_1 axi_smc_1
       (.M00_AXI_araddr(axi_smc_1_M00_AXI_ARADDR),
        ...
        .S05_AXI_awsize({1'b0,1'b1,1'b1}),
        .S05_AXI_awvalid(1'b0),
        .S05_AXI_bready(1'b0),
        .S05_AXI_wdata({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .S05_AXI_wlast(1'b0),
        .S05_AXI_wstrb({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .S05_AXI_wvalid(1'b0),
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_150_peripheral_aresetn));
  ...
  design_1_fft_convolve_0_0 fft_convolve_0
       (.m_output_data_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .m_output_data_tstrb(fft_convolve_0_M_OUTPUT_DATA_TSTRB),
  ...
  assign ilconstant_1_dout = 6'h07;
  ...
  design_1_usp_rf_data_converter_0_1 usp_rf_data_converter_0
       (.adc2_01_nco_freq({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .adc2_01_nco_phase({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .adc2_01_nco_phase_rst(1'b0),
        .adc2_01_nco_update_en(ilconstant_1_dout),
        .adc2_clk_n(adc2_clk_clk_n),
        .adc2_clk_p(adc2_clk_clk_p),
        .adc2_nco_update_req(1'b0),
