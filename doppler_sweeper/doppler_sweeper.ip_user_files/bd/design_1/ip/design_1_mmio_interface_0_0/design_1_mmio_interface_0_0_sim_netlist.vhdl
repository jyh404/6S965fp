...
-- Date        : Wed Dec 10 14:42:51 2025
-- Host        : eecs-digital-36 running 64-bit Ubuntu 24.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/jhuang25/Documents/6S965fp/doppler_sweeper/doppler_sweeper.gen/sources_1/bd/design_1/ip/design_1_mmio_interface_0_0/design_1_mmio_interface_0_0_sim_netlist.vhdl
...
entity design_1_mmio_interface_0_0_mmio_interface_slave_lite_v1_0_S00_AXI is
  port (
    scaling : out STD_LOGIC_VECTOR ( 3 downto 0 );
    prn_id : out STD_LOGIC_VECTOR ( 5 downto 0 );
...
architecture STRUCTURE of design_1_mmio_interface_0_0_mmio_interface_slave_lite_v1_0_S00_AXI is
  ...
  signal \ms_counter[3]_i_2_n_0\ : STD_LOGIC;
  signal \ms_counter[4]_i_1_n_0\ : STD_LOGIC;
  signal \ms_counter[5]_i_1_n_0\ : STD_LOGIC;
  signal \ms_counter[5]_i_2_n_0\ : STD_LOGIC;
  signal \ms_counter[5]_i_3_n_0\ : STD_LOGIC;
  signal \ms_counter[6]_i_1_n_0\ : STD_LOGIC;
  signal \ms_counter[7]_i_1_n_0\ : STD_LOGIC;
  signal \ms_counter[7]_i_2_n_0\ : STD_LOGIC;
  signal \ms_counter[7]_i_3_n_0\ : STD_LOGIC;
  signal \ms_counter[8]_i_1_n_0\ : STD_LOGIC;
  signal \ms_counter[9]_i_1_n_0\ : STD_LOGIC;
  signal ms_counter_0 : STD_LOGIC;
  signal p_1_in : STD_LOGIC_VECTOR ( 31 downto 3 );
  signal \^prn_id\ : STD_LOGIC_VECTOR ( 5 downto 0 );
  ...
  signal \^scaling\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \ms_counter[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \ms_counter[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \ms_counter[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ms_counter[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ms_counter[5]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ms_counter[7]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \ms_counter[7]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ms_counter[8]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \ms_counter[9]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of probe_reg_i_3 : label is "soft_lutpair4";
begin
  axi_arready_reg_0 <= \^axi_arready_reg_0\;
  axi_awready_reg_0 <= \^axi_awready_reg_0\;
  axi_rvalid_reg_0 <= \^axi_rvalid_reg_0\;
  prn_id(5 downto 0) <= \^prn_id\(5 downto 0);
  probe <= \^probe\;
  s00_axi_bvalid <= \^s00_axi_bvalid\;
  s00_axi_wready <= \^s00_axi_wready\;
  scaling(3 downto 0) <= \^scaling\(3 downto 0);
\FSM_sequential_state_read[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"405540FF40FF40FF"
    )
        port map (
      I0 => state_read(0),
      I1 => s00_axi_rready,
...
\counter[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => trigger_reg_i_3_n_0,
      I2 => trigger_reg_i_2_n_0,
      I3 => s00_axi_aresetn,
...
\ms_counter[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => ms_counter(6),
      I2 => ms_counter(7),
      I3 => \ms_counter[3]_i_2_n_0\,
      I4 => \ms_counter[5]_i_3_n_0\,
      I5 => ms_counter(3),
      O => \ms_counter[3]_i_1_n_0\
    );
\ms_counter[3]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F7"
    )
        port map (
...
\ms_counter[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0F0F0F0BCACB0A0"
    )
        port map (
      I0 => \ms_counter[7]_i_2_n_0\,
      I1 => ms_counter(3),
      I2 => ms_counter(5),
      I3 => \ms_counter[5]_i_2_n_0\,
      I4 => ms_counter(4),
      I5 => \ms_counter[5]_i_3_n_0\,
      O => \ms_counter[5]_i_1_n_0\
    );
\ms_counter[5]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => ms_counter(6),
      I1 => ms_counter(7),
      O => \ms_counter[5]_i_2_n_0\
    );
\ms_counter[5]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\ms_counter[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => ms_counter(4),
      I3 => ms_counter(6),
      I4 => \ms_counter[7]_i_2_n_0\,
      I5 => \ms_counter[7]_i_3_n_0\,
      O => \ms_counter[6]_i_1_n_0\
    );
\ms_counter[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\ms_counter[7]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0FF7"
    )
        port map (
      ...
      I2 => ms_counter(4),
      I3 => ms_counter(3),
      O => \ms_counter[7]_i_2_n_0\
    );
\ms_counter[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\ms_counter[8]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => ms_counter(9),
      I1 => ms_counter(8),
      I2 => probe_reg_i_2_n_0,
      I3 => ms_counter(4),
      I4 => ms_counter(3),
      O => \ms_counter[8]_i_1_n_0\
    );
\ms_counter[9]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"C6CCCCC4"
    )
        port map (
...
probe_reg_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => trigger_reg_i_2_n_0,
      I2 => trigger_reg_i_4_n_0,
      I3 => trigger_reg_i_3_n_0,
      I4 => probe_reg_i_3_n_0,
      I5 => \^probe\,
      O => probe_reg_i_1_n_0
    );
...
probe_reg_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0040"
    )
        port map (
...
\slv_reg0[15]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00020000"
        ...
        port map (
      I0 => s00_axi_wvalid,
      I1 => \slv_reg0[3]_i_3_n_0\,
      I2 => \slv_reg0[3]_i_4_n_0\,
      I3 => \slv_reg0[3]_i_5_n_0\,
      I4 => s00_axi_wstrb(1),
      O => p_1_in(15)
    );
...
\slv_reg0[3]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\slv_reg0[3]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\slv_reg0[3]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
trigger_reg_i_2: unisim.vcomponents.LUT6
    generic map(
...
trigger_reg_i_3: unisim.vcomponents.LUT6
    generic map(
...
trigger_reg_i_4: unisim.vcomponents.LUT6
    generic map(
