...
(* CORE_GENERATION_INFO = "bd_69f9,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_69f9,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=51,numReposBlks=39,numNonXlnxBlks=0,numHierBlks=12,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "design_1_axi_smc_1_2.hwdef" *) 
module bd_69f9
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  s03_entry_pipeline_imp_1E3B5CK s03_entry_pipeline
       (.aclk(aclk_4),
        .aresetn(aresetn_5),
  ...
  s03_nodes_imp_1BN5KQ0 s03_nodes
...
module s03_entry_pipeline_imp_1E3B5CK
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_69f9_s03mmu_0 s03_mmu
       (.aclk(aclk),
        ...
        .s_axi_rresp(s_axi_rresp),
        .s_axi_rvalid(s_axi_rvalid));
  bd_69f9_s03sic_0 s03_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_araddr(m_axi_araddr),
        .m_axi_arcache(m_axi_arcache),
  ...
  bd_69f9_s03tr_0 s03_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
