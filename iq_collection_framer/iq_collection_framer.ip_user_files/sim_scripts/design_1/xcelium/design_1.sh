...
#
# Script generated by Vivado on Tue Dec 09 12:03:41 EST 2025
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/aloy_ng/proj/6S965fp/iq_collection_framer/iq_collection_framer.cache/compile_simlib/xcelium"
  fi
