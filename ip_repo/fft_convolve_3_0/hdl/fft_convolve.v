...
`timescale 1 ns / 1 ps
    ...
    always @(*) begin
        real_prod = $signed($signed(fft_prn_tdata_reg[31:16]) * $signed(fft_iq_tdata_reg[31:16]) - $signed(fft_prn_tdata_reg[15:0]) * $signed(fft_iq_tdata_reg[15:0]));
        imag_prod = $signed($signed(fft_prn_tdata_reg[15:0]) * $signed(fft_iq_tdata_reg[31:16]) + $signed(fft_prn_tdata_reg[31:16]) * $signed(fft_iq_tdata_reg[15:0]));
