...
`timescale 1 ns / 1 ps
	...
	(
		...
		// Parameters of Axi Slave Bus Interface S_AXIS_IQ_data
		parameter integer C_S_AXIS_IQ_data_TDATA_WIDTH	= 32,
	...
	xfft_8192 fft_prn (
        ...
        .s_axis_data_tdata(s_axis_data_tdata[61:32]),               // input wire [31 : 0] s_axis_data_tdata
	...
	xfft_8192 fft_iq (
        ...
        .s_axis_data_tdata(s_axis_data_tdata[31:0]),                // input wire [31 : 0] s_axis_data_tdata
        .s_axis_data_tvalid(s_axis_data_tvalid),                    // input wire s_axis_data_tvalid
    ...
    always @(posedge s_axis_data_aclk) begin
        ...
        fft_data_tvalid_reg <= fft_prn_axis_data_tvalid;
        fft_data_tlast_reg <= fft_prn_axis_data_tlast;
    end
    
    always @(*) begin
        real_prod = $signed($signed(fft_prn_tdata_reg[31:16]) * $signed(fft_iq_tdata_reg[31:16]) - $signed(fft_prn_tdata_reg[15:0]) * $signed(fft_iq_tdata_reg[15:0])) >>> 16;
        imag_prod = $signed($signed(fft_prn_tdata_reg[15:0]) * $signed(fft_iq_tdata_reg[31:16]) + $signed(fft_prn_tdata_reg[31:16]) * $signed(fft_iq_tdata_reg[15:0])) >>> 16;
    end
	...
	xfft_8192 ifft (
        ...
        .m_axis_data_tdata(m_axis_output_data_tdata),               // output wire [31 : 0] m_axis_data_tdata
