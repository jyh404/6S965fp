...
#
# Script generated by Vivado on Tue Dec 09 13:30:24 EST 2025
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jhuang25/Documents/6.S965/6S965fp/test_bram/test_bram.cache/compile_simlib/xcelium"
  fi
