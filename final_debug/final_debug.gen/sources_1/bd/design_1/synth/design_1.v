...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=24,numReposBlks=24,numNonXlnxBlks=5,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=35,da_clkrst_cnt=13,da_rf_converter_usp_cnt=1,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (adc2_clk_clk_n,
    adc2_clk_clk_p,
    led,
  ...
  wire [31:0]axi_iq_M_AXIS_MM2S_TDATA;
  wire axi_iq_M_AXIS_MM2S_TLAST;
  wire axi_iq_M_AXIS_MM2S_TREADY;
  wire axi_iq_M_AXIS_MM2S_TVALID;
  wire [31:0]axi_iq_M_AXI_MM2S_ARADDR;
  wire [1:0]axi_iq_M_AXI_MM2S_ARBURST;
  wire [3:0]axi_iq_M_AXI_MM2S_ARCACHE;
  wire [7:0]axi_iq_M_AXI_MM2S_ARLEN;
  wire [2:0]axi_iq_M_AXI_MM2S_ARPROT;
  wire axi_iq_M_AXI_MM2S_ARREADY;
  wire [2:0]axi_iq_M_AXI_MM2S_ARSIZE;
  wire axi_iq_M_AXI_MM2S_ARVALID;
  wire [31:0]axi_iq_M_AXI_MM2S_RDATA;
  wire axi_iq_M_AXI_MM2S_RLAST;
  wire axi_iq_M_AXI_MM2S_RREADY;
  wire [1:0]axi_iq_M_AXI_MM2S_RRESP;
  wire axi_iq_M_AXI_MM2S_RVALID;
  wire [31:0]axi_iq_M_AXI_S2MM_AWADDR;
  wire [1:0]axi_iq_M_AXI_S2MM_AWBURST;
  wire [3:0]axi_iq_M_AXI_S2MM_AWCACHE;
  wire [7:0]axi_iq_M_AXI_S2MM_AWLEN;
  wire [2:0]axi_iq_M_AXI_S2MM_AWPROT;
  wire axi_iq_M_AXI_S2MM_AWREADY;
  wire [2:0]axi_iq_M_AXI_S2MM_AWSIZE;
  wire axi_iq_M_AXI_S2MM_AWVALID;
  wire axi_iq_M_AXI_S2MM_BREADY;
  wire [1:0]axi_iq_M_AXI_S2MM_BRESP;
  wire axi_iq_M_AXI_S2MM_BVALID;
  wire [31:0]axi_iq_M_AXI_S2MM_WDATA;
  wire axi_iq_M_AXI_S2MM_WLAST;
  wire axi_iq_M_AXI_S2MM_WREADY;
  wire [3:0]axi_iq_M_AXI_S2MM_WSTRB;
  wire axi_iq_M_AXI_S2MM_WVALID;
  ...
  wire [31:0]axi_prn_M_AXIS_MM2S_TDATA;
  wire axi_prn_M_AXIS_MM2S_TLAST;
  wire axi_prn_M_AXIS_MM2S_TREADY;
  wire axi_prn_M_AXIS_MM2S_TVALID;
  wire [31:0]axi_prn_M_AXI_MM2S_ARADDR;
  wire [1:0]axi_prn_M_AXI_MM2S_ARBURST;
  wire [3:0]axi_prn_M_AXI_MM2S_ARCACHE;
  wire [7:0]axi_prn_M_AXI_MM2S_ARLEN;
  wire [2:0]axi_prn_M_AXI_MM2S_ARPROT;
  wire axi_prn_M_AXI_MM2S_ARREADY;
  wire [2:0]axi_prn_M_AXI_MM2S_ARSIZE;
  wire axi_prn_M_AXI_MM2S_ARVALID;
  wire [31:0]axi_prn_M_AXI_MM2S_RDATA;
  wire axi_prn_M_AXI_MM2S_RLAST;
  wire axi_prn_M_AXI_MM2S_RREADY;
  wire [1:0]axi_prn_M_AXI_MM2S_RRESP;
  wire axi_prn_M_AXI_MM2S_RVALID;
  wire [31:0]axi_prn_M_AXI_S2MM_AWADDR;
  wire [1:0]axi_prn_M_AXI_S2MM_AWBURST;
  wire [3:0]axi_prn_M_AXI_S2MM_AWCACHE;
  wire [7:0]axi_prn_M_AXI_S2MM_AWLEN;
  wire [2:0]axi_prn_M_AXI_S2MM_AWPROT;
  wire axi_prn_M_AXI_S2MM_AWREADY;
  wire [2:0]axi_prn_M_AXI_S2MM_AWSIZE;
  wire axi_prn_M_AXI_S2MM_AWVALID;
  wire axi_prn_M_AXI_S2MM_BREADY;
  wire [1:0]axi_prn_M_AXI_S2MM_BRESP;
  wire axi_prn_M_AXI_S2MM_BVALID;
  wire [31:0]axi_prn_M_AXI_S2MM_WDATA;
  wire axi_prn_M_AXI_S2MM_WLAST;
  wire axi_prn_M_AXI_S2MM_WREADY;
  wire [3:0]axi_prn_M_AXI_S2MM_WSTRB;
  wire axi_prn_M_AXI_S2MM_WVALID;
  ...
  wire [9:0]axi_smc_M07_AXI_ARADDR;
  wire axi_smc_M07_AXI_ARREADY;
  wire axi_smc_M07_AXI_ARVALID;
  wire [9:0]axi_smc_M07_AXI_AWADDR;
  ...
  design_1_axi_dma_1_1 axi_iq
       (.axi_resetn(proc_sys_reset_0_150_peripheral_aresetn),
        .m_axi_mm2s_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .m_axi_mm2s_araddr(axi_iq_M_AXI_MM2S_ARADDR),
        .m_axi_mm2s_arburst(axi_iq_M_AXI_MM2S_ARBURST),
        .m_axi_mm2s_arcache(axi_iq_M_AXI_MM2S_ARCACHE),
        .m_axi_mm2s_arlen(axi_iq_M_AXI_MM2S_ARLEN),
        .m_axi_mm2s_arprot(axi_iq_M_AXI_MM2S_ARPROT),
        .m_axi_mm2s_arready(axi_iq_M_AXI_MM2S_ARREADY),
        .m_axi_mm2s_arsize(axi_iq_M_AXI_MM2S_ARSIZE),
        .m_axi_mm2s_arvalid(axi_iq_M_AXI_MM2S_ARVALID),
        .m_axi_mm2s_rdata(axi_iq_M_AXI_MM2S_RDATA),
        .m_axi_mm2s_rlast(axi_iq_M_AXI_MM2S_RLAST),
        .m_axi_mm2s_rready(axi_iq_M_AXI_MM2S_RREADY),
        .m_axi_mm2s_rresp(axi_iq_M_AXI_MM2S_RRESP),
        .m_axi_mm2s_rvalid(axi_iq_M_AXI_MM2S_RVALID),
        .m_axi_s2mm_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .m_axi_s2mm_awaddr(axi_iq_M_AXI_S2MM_AWADDR),
        .m_axi_s2mm_awburst(axi_iq_M_AXI_S2MM_AWBURST),
        .m_axi_s2mm_awcache(axi_iq_M_AXI_S2MM_AWCACHE),
        .m_axi_s2mm_awlen(axi_iq_M_AXI_S2MM_AWLEN),
        .m_axi_s2mm_awprot(axi_iq_M_AXI_S2MM_AWPROT),
        .m_axi_s2mm_awready(axi_iq_M_AXI_S2MM_AWREADY),
        .m_axi_s2mm_awsize(axi_iq_M_AXI_S2MM_AWSIZE),
        .m_axi_s2mm_awvalid(axi_iq_M_AXI_S2MM_AWVALID),
        .m_axi_s2mm_bready(axi_iq_M_AXI_S2MM_BREADY),
        .m_axi_s2mm_bresp(axi_iq_M_AXI_S2MM_BRESP),
        .m_axi_s2mm_bvalid(axi_iq_M_AXI_S2MM_BVALID),
        .m_axi_s2mm_wdata(axi_iq_M_AXI_S2MM_WDATA),
        .m_axi_s2mm_wlast(axi_iq_M_AXI_S2MM_WLAST),
        .m_axi_s2mm_wready(axi_iq_M_AXI_S2MM_WREADY),
        .m_axi_s2mm_wstrb(axi_iq_M_AXI_S2MM_WSTRB),
        .m_axi_s2mm_wvalid(axi_iq_M_AXI_S2MM_WVALID),
        .m_axis_mm2s_tdata(axi_iq_M_AXIS_MM2S_TDATA),
        .m_axis_mm2s_tlast(axi_iq_M_AXIS_MM2S_TLAST),
        .m_axis_mm2s_tready(axi_iq_M_AXIS_MM2S_TREADY),
        .m_axis_mm2s_tvalid(axi_iq_M_AXIS_MM2S_TVALID),
        .s_axi_lite_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s_axis_s2mm_tdata(axi_ram_0_M00_AXIS_TDATA),
        .s_axis_s2mm_tkeep({1'b1,1'b1,1'b1,1'b1}),
        .s_axis_s2mm_tlast(axi_ram_0_M00_AXIS_TLAST),
        .s_axis_s2mm_tready(axi_ram_0_M00_AXIS_TREADY),
        .s_axis_s2mm_tvalid(axi_ram_0_M00_AXIS_TVALID));
  ...
  design_1_axi_dma_1_2 axi_prn
       (.axi_resetn(proc_sys_reset_0_150_peripheral_aresetn),
        .m_axi_mm2s_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .m_axi_mm2s_araddr(axi_prn_M_AXI_MM2S_ARADDR),
        .m_axi_mm2s_arburst(axi_prn_M_AXI_MM2S_ARBURST),
        .m_axi_mm2s_arcache(axi_prn_M_AXI_MM2S_ARCACHE),
        .m_axi_mm2s_arlen(axi_prn_M_AXI_MM2S_ARLEN),
        .m_axi_mm2s_arprot(axi_prn_M_AXI_MM2S_ARPROT),
        .m_axi_mm2s_arready(axi_prn_M_AXI_MM2S_ARREADY),
        .m_axi_mm2s_arsize(axi_prn_M_AXI_MM2S_ARSIZE),
        .m_axi_mm2s_arvalid(axi_prn_M_AXI_MM2S_ARVALID),
        .m_axi_mm2s_rdata(axi_prn_M_AXI_MM2S_RDATA),
        .m_axi_mm2s_rlast(axi_prn_M_AXI_MM2S_RLAST),
        .m_axi_mm2s_rready(axi_prn_M_AXI_MM2S_RREADY),
        .m_axi_mm2s_rresp(axi_prn_M_AXI_MM2S_RRESP),
        .m_axi_mm2s_rvalid(axi_prn_M_AXI_MM2S_RVALID),
        .m_axi_s2mm_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .m_axi_s2mm_awaddr(axi_prn_M_AXI_S2MM_AWADDR),
        .m_axi_s2mm_awburst(axi_prn_M_AXI_S2MM_AWBURST),
        .m_axi_s2mm_awcache(axi_prn_M_AXI_S2MM_AWCACHE),
        .m_axi_s2mm_awlen(axi_prn_M_AXI_S2MM_AWLEN),
        .m_axi_s2mm_awprot(axi_prn_M_AXI_S2MM_AWPROT),
        .m_axi_s2mm_awready(axi_prn_M_AXI_S2MM_AWREADY),
        .m_axi_s2mm_awsize(axi_prn_M_AXI_S2MM_AWSIZE),
        .m_axi_s2mm_awvalid(axi_prn_M_AXI_S2MM_AWVALID),
        .m_axi_s2mm_bready(axi_prn_M_AXI_S2MM_BREADY),
        .m_axi_s2mm_bresp(axi_prn_M_AXI_S2MM_BRESP),
        .m_axi_s2mm_bvalid(axi_prn_M_AXI_S2MM_BVALID),
        .m_axi_s2mm_wdata(axi_prn_M_AXI_S2MM_WDATA),
        .m_axi_s2mm_wlast(axi_prn_M_AXI_S2MM_WLAST),
        .m_axi_s2mm_wready(axi_prn_M_AXI_S2MM_WREADY),
        .m_axi_s2mm_wstrb(axi_prn_M_AXI_S2MM_WSTRB),
        .m_axi_s2mm_wvalid(axi_prn_M_AXI_S2MM_WVALID),
        .m_axis_mm2s_tdata(axi_prn_M_AXIS_MM2S_TDATA),
        .m_axis_mm2s_tlast(axi_prn_M_AXIS_MM2S_TLAST),
        .m_axis_mm2s_tready(axi_prn_M_AXIS_MM2S_TREADY),
        .m_axis_mm2s_tvalid(axi_prn_M_AXIS_MM2S_TVALID),
        .s_axi_lite_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .s_axi_lite_araddr(axi_smc_M07_AXI_ARADDR),
        .s_axi_lite_arready(axi_smc_M07_AXI_ARREADY),
        .s_axi_lite_arvalid(axi_smc_M07_AXI_ARVALID),
        .s_axi_lite_awaddr(axi_smc_M07_AXI_AWADDR),
        .s_axi_lite_awready(axi_smc_M07_AXI_AWREADY),
        .s_axi_lite_awvalid(axi_smc_M07_AXI_AWVALID),
        .s_axi_lite_bready(axi_smc_M07_AXI_BREADY),
        .s_axi_lite_bresp(axi_smc_M07_AXI_BRESP),
        .s_axi_lite_bvalid(axi_smc_M07_AXI_BVALID),
        .s_axi_lite_rdata(axi_smc_M07_AXI_RDATA),
        .s_axi_lite_rready(axi_smc_M07_AXI_RREADY),
        .s_axi_lite_rresp(axi_smc_M07_AXI_RRESP),
        .s_axi_lite_rvalid(axi_smc_M07_AXI_RVALID),
        .s_axi_lite_wdata(axi_smc_M07_AXI_WDATA),
        .s_axi_lite_wready(axi_smc_M07_AXI_WREADY),
        .s_axi_lite_wvalid(axi_smc_M07_AXI_WVALID),
        .s_axis_s2mm_tdata(axi_rom_0_M00_AXIS_TDATA),
        .s_axis_s2mm_tkeep({1'b1,1'b1,1'b1,1'b1}),
        .s_axis_s2mm_tlast(axi_rom_0_M00_AXIS_TLAST),
        .s_axis_s2mm_tready(axi_rom_0_M00_AXIS_TREADY),
        .s_axis_s2mm_tvalid(axi_rom_0_M00_AXIS_TVALID));
  ...
  design_1_axi_smc_1_1 axi_smc_1
       (.M00_AXI_araddr(axi_smc_1_M00_AXI_ARADDR),
        ...
        .S04_AXI_awaddr(axi_iq_M_AXI_S2MM_AWADDR),
        .S04_AXI_awburst(axi_iq_M_AXI_S2MM_AWBURST),
        .S04_AXI_awcache(axi_iq_M_AXI_S2MM_AWCACHE),
        .S04_AXI_awlen(axi_iq_M_AXI_S2MM_AWLEN),
        .S04_AXI_awlock(1'b0),
        .S04_AXI_awprot(axi_iq_M_AXI_S2MM_AWPROT),
        .S04_AXI_awqos({1'b0,1'b0,1'b0,1'b0}),
        .S04_AXI_awready(axi_iq_M_AXI_S2MM_AWREADY),
        .S04_AXI_awsize(axi_iq_M_AXI_S2MM_AWSIZE),
        .S04_AXI_awvalid(axi_iq_M_AXI_S2MM_AWVALID),
        .S04_AXI_bready(axi_iq_M_AXI_S2MM_BREADY),
        .S04_AXI_bresp(axi_iq_M_AXI_S2MM_BRESP),
        .S04_AXI_bvalid(axi_iq_M_AXI_S2MM_BVALID),
        .S04_AXI_wdata(axi_iq_M_AXI_S2MM_WDATA),
        .S04_AXI_wlast(axi_iq_M_AXI_S2MM_WLAST),
        .S04_AXI_wready(axi_iq_M_AXI_S2MM_WREADY),
        .S04_AXI_wstrb(axi_iq_M_AXI_S2MM_WSTRB),
        .S04_AXI_wvalid(axi_iq_M_AXI_S2MM_WVALID),
        .S05_AXI_awaddr(axi_prn_M_AXI_S2MM_AWADDR),
        .S05_AXI_awburst(axi_prn_M_AXI_S2MM_AWBURST),
        .S05_AXI_awcache(axi_prn_M_AXI_S2MM_AWCACHE),
        .S05_AXI_awlen(axi_prn_M_AXI_S2MM_AWLEN),
        .S05_AXI_awlock(1'b0),
        .S05_AXI_awprot(axi_prn_M_AXI_S2MM_AWPROT),
        .S05_AXI_awqos({1'b0,1'b0,1'b0,1'b0}),
        .S05_AXI_awready(axi_prn_M_AXI_S2MM_AWREADY),
        .S05_AXI_awsize(axi_prn_M_AXI_S2MM_AWSIZE),
        .S05_AXI_awvalid(axi_prn_M_AXI_S2MM_AWVALID),
        .S05_AXI_bready(axi_prn_M_AXI_S2MM_BREADY),
        .S05_AXI_bresp(axi_prn_M_AXI_S2MM_BRESP),
        .S05_AXI_bvalid(axi_prn_M_AXI_S2MM_BVALID),
        .S05_AXI_wdata(axi_prn_M_AXI_S2MM_WDATA),
        .S05_AXI_wlast(axi_prn_M_AXI_S2MM_WLAST),
        .S05_AXI_wready(axi_prn_M_AXI_S2MM_WREADY),
        .S05_AXI_wstrb(axi_prn_M_AXI_S2MM_WSTRB),
        .S05_AXI_wvalid(axi_prn_M_AXI_S2MM_WVALID),
        .S06_AXI_araddr(axi_iq_M_AXI_MM2S_ARADDR),
        .S06_AXI_arburst(axi_iq_M_AXI_MM2S_ARBURST),
        .S06_AXI_arcache(axi_iq_M_AXI_MM2S_ARCACHE),
        .S06_AXI_arlen(axi_iq_M_AXI_MM2S_ARLEN),
        .S06_AXI_arlock(1'b0),
        .S06_AXI_arprot(axi_iq_M_AXI_MM2S_ARPROT),
        .S06_AXI_arqos({1'b0,1'b0,1'b0,1'b0}),
        .S06_AXI_arready(axi_iq_M_AXI_MM2S_ARREADY),
        .S06_AXI_arsize(axi_iq_M_AXI_MM2S_ARSIZE),
        .S06_AXI_arvalid(axi_iq_M_AXI_MM2S_ARVALID),
        .S06_AXI_rdata(axi_iq_M_AXI_MM2S_RDATA),
        .S06_AXI_rlast(axi_iq_M_AXI_MM2S_RLAST),
        .S06_AXI_rready(axi_iq_M_AXI_MM2S_RREADY),
        .S06_AXI_rresp(axi_iq_M_AXI_MM2S_RRESP),
        .S06_AXI_rvalid(axi_iq_M_AXI_MM2S_RVALID),
        .S07_AXI_araddr(axi_prn_M_AXI_MM2S_ARADDR),
        .S07_AXI_arburst(axi_prn_M_AXI_MM2S_ARBURST),
        .S07_AXI_arcache(axi_prn_M_AXI_MM2S_ARCACHE),
        .S07_AXI_arlen(axi_prn_M_AXI_MM2S_ARLEN),
        .S07_AXI_arlock(1'b0),
        .S07_AXI_arprot(axi_prn_M_AXI_MM2S_ARPROT),
        .S07_AXI_arqos({1'b0,1'b0,1'b0,1'b0}),
        .S07_AXI_arready(axi_prn_M_AXI_MM2S_ARREADY),
        .S07_AXI_arsize(axi_prn_M_AXI_MM2S_ARSIZE),
        .S07_AXI_arvalid(axi_prn_M_AXI_MM2S_ARVALID),
        .S07_AXI_rdata(axi_prn_M_AXI_MM2S_RDATA),
        .S07_AXI_rlast(axi_prn_M_AXI_MM2S_RLAST),
        .S07_AXI_rready(axi_prn_M_AXI_MM2S_RREADY),
        .S07_AXI_rresp(axi_prn_M_AXI_MM2S_RRESP),
        .S07_AXI_rvalid(axi_prn_M_AXI_MM2S_RVALID),
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_150_peripheral_aresetn));
  ...
  design_1_fft_convolve_0_0 fft_convolve_0
       (.m_output_data_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s_iq_data_tdata(axi_iq_M_AXIS_MM2S_TDATA),
        .s_iq_data_tlast(axi_iq_M_AXIS_MM2S_TLAST),
        .s_iq_data_tready(axi_iq_M_AXIS_MM2S_TREADY),
        .s_iq_data_tstrb({1'b1,1'b1,1'b1,1'b1}),
        .s_iq_data_tvalid(axi_iq_M_AXIS_MM2S_TVALID),
        ...
        .s_prn_data_tdata(axi_prn_M_AXIS_MM2S_TDATA),
        .s_prn_data_tlast(axi_prn_M_AXIS_MM2S_TLAST),
        .s_prn_data_tready(axi_prn_M_AXIS_MM2S_TREADY),
        .s_prn_data_tstrb({1'b1,1'b1,1'b1,1'b1}),
        .s_prn_data_tvalid(axi_prn_M_AXIS_MM2S_TVALID),
