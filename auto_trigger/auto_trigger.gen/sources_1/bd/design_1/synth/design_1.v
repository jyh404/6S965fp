...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=23,numReposBlks=23,numNonXlnxBlks=6,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=38,da_clkrst_cnt=16,da_rf_converter_usp_cnt=1,da_zynq_ultra_ps_e_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (adc2_clk_clk_n,
    adc2_clk_clk_p,
    led,
  ...
  wire [31:0]axi_continuous_ram_0_M00_AXIS_TDATA;
  wire axi_continuous_ram_0_M00_AXIS_TLAST;
  wire axi_continuous_ram_0_M00_AXIS_TREADY;
  wire [3:0]axi_continuous_ram_0_M00_AXIS_TSTRB;
  wire axi_continuous_ram_0_M00_AXIS_TVALID;
  wire axi_continuous_ram_0_n_trigger;
  wire [31:0]axi_continuous_rom_0_M00_AXIS_TDATA;
  wire axi_continuous_rom_0_M00_AXIS_TLAST;
  wire axi_continuous_rom_0_M00_AXIS_TREADY;
  wire [3:0]axi_continuous_rom_0_M00_AXIS_TSTRB;
  wire axi_continuous_rom_0_M00_AXIS_TVALID;
  ...
  wire [5:0]mmio_interface_prn_id;
  ...
  design_1_axi_continuous_ram_0_0 axi_continuous_ram_0
       (.m00_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .m00_axis_aresetn(proc_sys_reset_0_150_peripheral_aresetn),
        .m00_axis_tdata(axi_continuous_ram_0_M00_AXIS_TDATA),
        .m00_axis_tlast(axi_continuous_ram_0_M00_AXIS_TLAST),
        .m00_axis_tready(axi_continuous_ram_0_M00_AXIS_TREADY),
        .m00_axis_tstrb(axi_continuous_ram_0_M00_AXIS_TSTRB),
        .m00_axis_tvalid(axi_continuous_ram_0_M00_AXIS_TVALID),
        .n_trigger(axi_continuous_ram_0_n_trigger),
        .s00_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .s00_axis_aresetn(proc_sys_reset_0_150_peripheral_aresetn),
  ...
  design_1_axi_continuous_rom_0_0 axi_continuous_rom_0
       (.m00_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .m00_axis_aresetn(proc_sys_reset_0_150_peripheral_aresetn),
        .m00_axis_tdata(axi_continuous_rom_0_M00_AXIS_TDATA),
        .m00_axis_tlast(axi_continuous_rom_0_M00_AXIS_TLAST),
        .m00_axis_tready(axi_continuous_rom_0_M00_AXIS_TREADY),
        .m00_axis_tstrb(axi_continuous_rom_0_M00_AXIS_TSTRB),
        .m00_axis_tvalid(axi_continuous_rom_0_M00_AXIS_TVALID),
        .new_trigger(axi_continuous_ram_0_n_trigger),
        .prn_id(mmio_interface_prn_id));
  ...
  design_1_fft_convolve_0_0 fft_convolve_0
       (.m_output_data_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s_iq_data_tdata(axi_continuous_ram_0_M00_AXIS_TDATA),
        .s_iq_data_tlast(axi_continuous_ram_0_M00_AXIS_TLAST),
        .s_iq_data_tready(axi_continuous_ram_0_M00_AXIS_TREADY),
        .s_iq_data_tstrb(axi_continuous_ram_0_M00_AXIS_TSTRB),
        .s_iq_data_tvalid(axi_continuous_ram_0_M00_AXIS_TVALID),
        ...
        .s_prn_data_tdata(axi_continuous_rom_0_M00_AXIS_TDATA),
        .s_prn_data_tlast(axi_continuous_rom_0_M00_AXIS_TLAST),
        .s_prn_data_tready(axi_continuous_rom_0_M00_AXIS_TREADY),
        .s_prn_data_tstrb(axi_continuous_rom_0_M00_AXIS_TSTRB),
        .s_prn_data_tvalid(axi_continuous_rom_0_M00_AXIS_TVALID),
