...
(* CORE_GENERATION_INFO = "bd_68b9,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_68b9,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=43,numReposBlks=33,numNonXlnxBlks=0,numHierBlks=10,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "design_1_axi_smc_1_1.hwdef" *) 
module bd_68b9
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
