...
module fft_convolve #
	...
	// we need to scale arithmetically
	// empirically 17 is maybe too little

	wire [39:0] real_prod;
	wire [39:0] imag_prod;

	assign real_prod = ($signed(fft_mult_tdata[39:0]) >>> 17);
	assign imag_prod = ($signed(fft_mult_tdata[79:40]) >>> 17);
	...
	xfft_8192 ifft (
        ...
        .s_axis_data_tdata({real_prod[15:0], imag_prod[15:0]}),   	// input wire [31 : 0] s_axis_data_tdata
