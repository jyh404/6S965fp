...
module fft_convolve #
	...
	// note that multiplier works with imag on top of real, which is flipped of FFT
	
	// WE CONJUGATE THE PRN FFT BY NEGATING THE IMAGINARY PART
	...
	cmpy_0 multiplier (
		...
		.s_axis_a_tdata({-$signed(fft_prn_data_tdata[31:16]), fft_prn_data_tdata[63:48]}),
	...
	// make it adjustable from some input port, which we can set via MMIO?

	wire [39:0] scaled_fft_real = $signed(fft_mult_tdata[39:0]) >>> scaling;
	wire [39:0] scaled_fft_imag = $signed(fft_mult_tdata[79:40]) >>> scaling;
	...
	xfft_4096 ifft (
        ...
        .s_axis_data_tdata({scaled_fft_real[15:0], scaled_fft_imag[15:0]}),   	// input wire [31 : 0] s_axis_data_tdata
