...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_68b9.protoinst" -protoinst "protoinst_files/bd_6e42.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib xbip_utils_v3_0_14 axi_utils_v2_0_10 mult_gen_v12_0_23 xbip_pipe_v3_0_10 xbip_dsp48_wrapper_v3_0_7 floating_point_v7_1_20 cmpy_v6_0_26 c_reg_fd_v12_0_10 c_addsub_v12_0_20 c_shift_ram_v12_0_19 xfft_v9_1_14)
