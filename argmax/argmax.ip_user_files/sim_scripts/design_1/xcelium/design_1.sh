...
#
# Script generated by Vivado on Tue Dec 09 23:42:53 EST 2025
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jhuang25/Documents/6.S965/6S965fp/argmax/argmax.cache/compile_simlib/xcelium"
  fi
